...
const credentials = {
  ...
  redirect_uris: ["https://ianrenas.github.io/meet/"],
  javascript_origins: ["https://ianrenas.github.io", "http://localhost:3000"],
};
...
module.exports.getCalendarEvents = async (event) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    // to get list of calender events from google
