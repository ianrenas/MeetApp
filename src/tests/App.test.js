...
//first test making sure EventList gets "events" as a prop from App, where it will be defined in its state
describe('<App /> integration', () => {
  ...
  //second test making sure CitySearch gets "locations" as a prop from App, where it will be defined it its state
